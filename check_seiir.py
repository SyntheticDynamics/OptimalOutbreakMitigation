...
# -*- coding: utf-8 -*-
"""
Created on Mon Sep 28 14:26:21 2020
...
def u_ori(state, sys, e = 1e-10):
    ...
    S, E, Is, Ia, R = state
    if Is > phi(state, sys):
        return reg(Is - phi(state, sys), sys.umax, e)
    else:
        return 0
...
fig.savefig("docs/previous/seiir_robustness_check_173.jpg", format = "jpg")
...
fig.savefig("docs/previous/seiir_robustness_check_25.jpg", format = "jpg")
...
fig.savefig("docs/previous/seiir_robustness_check_364.jpg", format = "jpg")
...
fig.savefig("docs/previous/seiir_robustness_rs.jpg", format = "jpg")
